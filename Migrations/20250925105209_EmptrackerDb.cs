...
{
    /// <inheritdoc />
    public partial class EmptrackerDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakDurationHours = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Breaks", x => x.BreakId);
                    table.ForeignKey(
                        name: "FK_Breaks_WorkSessions_SessionId",
