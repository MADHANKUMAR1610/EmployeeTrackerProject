...
{
    /// <inheritdoc />
<<<<<<<< HEAD:Migrations/20250930073040_ETracker.cs
    public partial class ETracker : Migration
========
    public partial class Empldb : Migration
>>>>>>>> a93afc3e8872f637d992871ba6aa5c8cdc6418eb:Migrations/20250930072553_Empldb.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakDurationMinutes = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Breaks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Breaks_WorkSessions_WorkSessionId",
